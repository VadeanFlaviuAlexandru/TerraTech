...
* The original package name 'com.example.spring-boot-3-jwt-authentication-server' is invalid and this project uses 'com.example.springboot3jwtauthenticationserver' instead.
