...
public class JwtService {
    ...
    public JwtService(ManagerRepository managerRepository) {
    ...
    public Manager extractManager(String token) {
        String managerEmail = extractClaim(token, Claims::getSubject);
        return managerRepository.findByEmail(managerEmail);
    }

    public Long extractId(String token) {
        String idAsString = extractClaim(token, Claims::getId);
